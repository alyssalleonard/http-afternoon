...
class Search extends Component{
    ...
    render(){
        ...
        const blogResults = this.state.blogResults.map((result, index) => <BlogTile key={index} blog={result} /> )
        const userResults = this.state.userResults.map((result, index) => <UserTile key={index} user={result} /> )
